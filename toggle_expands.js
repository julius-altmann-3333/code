function toggleExpandConsulting() {
        ...
        function toggleExpandPortfolio() {
            const mapContainerPortfolio = document.getElementById('ContainerPortfolio');
            mapContainerPortfolio.classList.toggle('expanded-portfolio');
        }